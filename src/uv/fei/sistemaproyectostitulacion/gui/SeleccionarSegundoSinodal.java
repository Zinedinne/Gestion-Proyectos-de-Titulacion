 ...
 * @author oscar
 */
public class SeleccionarSegundoSinodal extends javax.swing.JFrame {
    ...
    String tipoProfesor = "";
    public static String nombreSegundoSinodal = "";
    ...
    public SeleccionarSegundoSinodal() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        GUIRegistrarProyectoTitulacion.jTextField7.setText(SeleccionarDirector.nombreProfesor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarSegundoSinodal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionarSegundoSinodal().setVisible(true);
            }
        });
    }
